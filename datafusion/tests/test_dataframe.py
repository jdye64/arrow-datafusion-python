...
from datafusion import FileCompressionType
...
def test_get_dataframe_compression(tmp_path):
    ctx = SessionContext()

    path = "/home/jeremy/Development/arrow-datafusion-python/testing/data/csv/aggregate_test_100.csv.gz"
    print(f"Path: {path}")
    # table = pa.Table.from_arrays(
    #     [
    #         [1, 2, 3, 4],
    ...
    ctx.register_csv("csv", path, file_extension=".csv.gz", file_compression_type=FileCompressionType("GZIP"))
